...
ActiveRecord::Schema[7.0].define(version: 2022_08_17_063750) do
  ...
  add_foreign_key "event_attendings", "events", column: "attendee_id"
  add_foreign_key "event_attendings", "users", column: "attended_events_id"
